...
COPY "public"."articles" (article_id, title, publishdate, author, article_body, category) FROM stdin;
...
COPY "public"."comments" (comment_id, body, author_id, date, article, "time", string_format_time) FROM stdin;
